...
ActiveRecord::Schema.define(version: 2020_05_02_193031) do
  ...
  create_table "countries_users", id: false, force: :cascade do |t|
    t.integer "country_id"
    t.integer "user_id"
    t.index ["country_id", "user_id"], name: "index_countries_users_on_country_id_and_user_id", unique: true
  ...
  create_table "travel_partners_trips", id: false, force: :cascade do |t|
    ...
    t.integer "trip_id"
    t.index ["travel_partner_id"], name: "index_travel_partners_trips_on_travel_partner_id"
